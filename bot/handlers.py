...
TEXTS = {
    ...
    "ru": {
        "welcome": (
            ...
            "в удобное для вас время с полным описанием и практическими советами.\n\n"
            "🌟 **Для кого это будет полезно:**\n"
            "• Практикующим йогу любого уровня\n"
            "• Тем, кто хочет развивать осознанность\n"
            "• Людям, стремящимся к духовному росту\n"
            "• Всем, кто интересуется философией йоги\n\n"
            "🔄 **Как это работает:**\n"
            "• Принципы выбираются случайно для каждого пользователя\n"
            "• Повторения возможны — это нормально и полезно!\n"
            "• Каждый принцип — это урок на день\n"
        ...
        "about_text": (
            "🕊️ **Бот принципов йоги**\n\n"
            "Этот бот ежедневно отправляет принципы йоги (ямы и ниямы), чтобы помочь вам в духовном развитии.\n\n"
            "🔹 **Случайные принципы** для каждого пользователя\n"
            "🔹 **Многоязычная** поддержка (английский/русский)\n"
            "🔹 **Настраиваемые** время и часовой пояс\n"
            "🔹 **Пропуск дней** по желанию\n\n"
            "Сделано с ❤️ для практикующих йогу"
        ),
        "feedback_prompt": (
